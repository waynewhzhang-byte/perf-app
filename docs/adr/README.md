...
| [0004](./0004-template-immutable-after-publish.md) | 模板发布后结构不可变，仅文字修订 | accepted |
| [0005](./0005-option-level-review.md) | 审核单位是 SubmissionOptionReview（逐选项） | accepted |
...
`docs/superpowers/specs/2026-06-13-architecture-decisions.md` 是一份较宽泛的"原则 + 性能 + 待办"
混合文档。本目录只摘出其中真正"难以回退 + 令人费解 + 真权衡"的决策，按 ADR 格式精简记录。
两个文档并存，**ADR 是决策的权威记录**，spec 文档保留为详细的原始讨论痕迹。
